...
export const SystemMetrics: React.FC = () => {
  const [timeRange, setTimeRange] = useState<'Last 1 Hour' | 'Last 24 Hours' | 'Last 7 Days'>('Last 1 Hour');

  return (
    <div
      id="system-metrics-card"
      className="bg-white dark:bg-[#090C14] border border-[#E5E8E5] dark:border-white/[0.08] rounded-2xl p-4 shadow-[0_1px_2px_rgba(15,23,42,0.02)] flex flex-col justify-between flex-1 min-h-[220px] transition-colors duration-300"
    >
      {/* Card Header */}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-2">
        ...
        <div className="bg-[#FAFAFA] dark:bg-[#0E121B] border border-[#F0F2F0] dark:border-white/[0.08] rounded-xl p-2.5 flex flex-col">
          ...
          <div className="flex items-baseline gap-1 mt-0.5">
            <span className="text-[17px] font-bold text-[#111312] dark:text-white font-mono">1.4s</span>
          </div>
        ...
        <div className="bg-[#FAFAFA] dark:bg-[#0E121B] border border-[#F0F2F0] dark:border-white/[0.08] rounded-xl p-2.5 flex flex-col">
          ...
          <div className="flex items-baseline gap-1 mt-0.5">
            <span className="text-[17px] font-bold text-[#111312] dark:text-white font-mono">98.4%</span>
          </div>
          <div className="flex items-center gap-1 text-[9.5px] text-[#15803D] dark:text-emerald-400 font-medium mt-0.5 font-mono">
        ...
        <div className="bg-[#FAFAFA] dark:bg-[#0E121B] border border-[#F0F2F0] dark:border-white/[0.08] rounded-xl p-2.5 flex flex-col">
          ...
          <div className="flex items-baseline gap-1 mt-0.5">
            <span className="text-[17px] font-bold text-[#111312] dark:text-white font-mono">24</span>
          </div>
          <div className="flex items-center gap-1 text-[9.5px] text-[#15803D] dark:text-emerald-400 font-medium mt-0.5 font-mono">
            <ArrowUpRight className="w-3 h-3 text-[#15803D] dark:text-emerald-400" />
            <span>+14 vs 24h</span>
        ...
        <div className="bg-[#FAFAFA] dark:bg-[#0E121B] border border-[#F0F2F0] dark:border-white/[0.08] rounded-xl p-2.5 flex flex-col">
          ...
          <div className="flex items-baseline gap-1 mt-0.5">
            <span className="text-[17px] font-bold text-[#111312] dark:text-white font-mono">96.7%</span>
          </div>
          <div className="flex items-center gap-1 text-[9.5px] text-[#15803D] dark:text-emerald-400 font-medium mt-0.5 font-mono">
            <ArrowUpRight className="w-3 h-3 text-[#15803D] dark:text-emerald-400" />
      ...
      <div className="h-[95px] w-full bg-[#FAFAFA] dark:bg-[#0E121B] rounded-xl border border-[#F0F2F0] dark:border-white/[0.08] p-1.5 flex flex-col justify-between">
        <div className="flex items-center justify-between px-1 text-[9.5px] text-[#606763] dark:text-zinc-400">
          ...
          <span className="text-[#15803D] dark:text-emerald-400 font-bold font-mono">● p99 1.42s Nominal</span>
        </div>

        <div className="h-[70px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart
              data={mockTelemetryHistory}
